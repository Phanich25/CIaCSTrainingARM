...
$subscriptionId = "d9174032-d76b-41c6-9763-3bbe9f3cd653" #insert your subscription ID
$resourceGroupName = "CIaCS-rg-Phani"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/Phanich25/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/Phanich25/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
